...
class AS5047P {
    ...
    uint16_t readAngle(bool withDAEC = true);
    ...
    void write_PROG(AS5047P_types::PROG_t regData);
    ...
    void write_ZPOSM(AS5047P_types::ZPOSM_t regData);
    void write_ZPOSL(AS5047P_types::ZPOSL_t regData);
    void write_SETTINGS1(AS5047P_types::SETTINGS1_t regData);
    void write_SETTINGS2(AS5047P_types::SETTINGS2_t regData);
